<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Chat.aspx.cs" Inherits="Unommer.Chat" %>
...
<head runat="server">
    <title>Unommer Chat : Chat Page</title>
    ...
    <script src="Script/date.format.js"></script>

    <!--EmojiOneArea -->
    <link href="Content/emojionearea.min.css" rel="stylesheet" />
    <script src="Script/emojionearea.js"></script>
        ...
        $(function () {
            ...
            window.onfocus = function (event) {
                if (event.explicitOriginalTarget === window) {
                    ...
                    document.title = 'Unommer Chat App';
                }
            }
        ...
        function registerEvents(chatHub) {
            ...
            $('#btnSendMsg').click(function () {
                ...
                if (msg.length > 0) {
                    ...
                    alert(date);
                    chatHub.server.sendMessageToAll(Userid, userName, msg, date, email);
                    $("#txtMessage").val('');
                }
            });
        ...
        function registerClientMethods(chatHub) {
            ...
            chatHub.client.messageReceived = function (userName, message, time, userimg) {
                ...
                if (CurrUser1 != userName) {
                    ...
                    IntervalVal = setInterval("ShowTitleAlert('Unommer Chat App', '" + Notification + "')", 800);
            ...
            chatHub.client.sendPrivateMessage = function (windowId, fromUserName, message, userimg, CurrentDateTime) {
                ...
                var divChatP = '<div class="direct-chat-msg ' + Side + '">' +
                    ...
                    ' <img class="direct-chat-img" src="' + userimg + '" alt="images/dummy.png">' +
    ...
    if (IsValidateFile(args.get_fileName())) {
        ...
        chatHub.server.sendMessageToAll(Userid, userName, msg1, date, email);
        ...
        <div class="content-wrapper">
            ...
            <header class="main-header" style="background: #bedaeb">
                ...
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><b>Unommer</b> Chat App</span>
                </a>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<%= UserImage %>" class="user-image" alt="images/dummy.png" />
                                    <span class="hidden-xs"><%= this.UserName %></span>
                                   <%-- <span class="hidden-xs"><%= this.Userid %></span>--%>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                                    <li class="user-header">
                                        <img src="<%= UserImage %>" class="img-circle" alt="images/dummy.png" />
                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary direct-chat direct-chat-primary">
                        ...
                        <div class="box-footer">
                            ...
                            <img id="imgDisplay" src="" class="user-image" style="height: 100px;" alt="" />
                        </div>
                        <!-- /.box-footer-->
                    </div>
                    <!--/.direct-chat -->

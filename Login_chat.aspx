<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login_chat.aspx.cs" Inherits="Unommer.Chat_Unommer.Login_chat" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Unommer Chat : Login</title>
    ...
    <form id="form1" runat="server">
        <div class="login-box">
            <div class="login-logo">
                <a href="Login.aspx"><b>Unommer </b>Chat App</a>
            </div>
            <!-- /.login-logo -->
